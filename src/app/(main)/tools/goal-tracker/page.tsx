  ...
  return (
    <div className="min-h-screen bg-zinc-50">
      <div className="mx-auto max-w-5xl px-6 py-10">
        ...
        {/* Page header */}
        <div className="mb-8">
          <Link href="/tools" className="inline-flex items-center gap-1.5 text-xs text-zinc-500 hover:text-zinc-700 mb-4">
            ...
            {data && (
              <div className="flex gap-2">
                <button
                  ...
                  className="flex items-center gap-1.5 rounded-lg border border-zinc-200 bg-white px-3 py-2 text-xs font-medium text-zinc-700 hover:bg-zinc-50"
                >
        ...
        <div className="mb-6 rounded-xl border border-zinc-200 bg-white p-4 shadow-sm">
          <label className="block mb-1.5 text-xs font-semibold text-zinc-600">Öğrenci Seç</label>
          <select
            value={selectedId}
            onChange={e => setSelectedId(e.target.value)}
            className="w-full rounded-lg border border-zinc-200 bg-zinc-50 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#023435]/30"
          >
          ...
          {selectedStudent && (
            <div className="mt-3 grid grid-cols-2 sm:grid-cols-4 gap-3 rounded-lg bg-zinc-50 p-3">
              <div>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              {data.modules.map(mod => {
                ...
                return (
                  <div key={mod.curriculum.id} className="rounded-xl border border-zinc-200 bg-white shadow-sm overflow-hidden">
                    <button
