...
export default function RegisterPage() {
  ...
  // We trigger it if ANY password field is visible and holds text logic
  ...
  }, [password, showPassword, passwordConfirm, showPasswordConfirm, isPurplePeeking]);
  ...
  const isShowPwdActive = (password.length > 0 && showPassword) || (passwordConfirm.length > 0 && showPasswordConfirm);
  const isTypingActive = isTyping || (password.length > 0 && !showPassword) || (passwordConfirm.length > 0 && !showPasswordConfirm);
    ...
    <div className="min-h-screen grid lg:grid-cols-2">
      ...
      <div className="relative hidden lg:flex flex-col justify-between bg-[#F4AE10]/20 p-12 text-[#692137]">
        ...
        <div className="relative z-20 flex items-end justify-center h-[500px]">
          ...
          <div className="relative" style={{ width: '550px', height: '400px' }}>
            ...
            >
              ...
              >
                <Pupil size={12} maxDistance={5} pupilColor="#2D2D2D" forceLookX={isShowPwdActive ? -5 : undefined} forceLookY={isShowPwdActive ? -4 : undefined} />
                <Pupil size={12} maxDistance={5} pupilColor="#2D2D2D" forceLookX={isShowPwdActive ? -5 : undefined} forceLookY={isShowPwdActive ? -4 : undefined} />
              </div>
            </div>
        ...
        <div className="relative z-20 flex flex-col items-start text-xs text-[#692137]/60">
          <p>© {new Date().getFullYear()} Luden Vox</p>
        </div>
