...
export const Sidebar = () => {
  ...
  const navItems = [
    ...
    { icon: Layers, title: "Kartlar", href: "/cards" },
    { icon: Activity, title: "Kart Üret", href: "/generate" },
  ];
  ...
  return (
    <>
      ...
      >
        ...
        {/* The Open/Close Toggle is hidden on mobile entirely */}
...
const TitleSection = ({ open, userName }: { open: boolean, userName: string }) => {
  return (
    <div className="mb-6 border-b border-gray-200 dark:border-gray-800 pb-4 pt-2 md:pt-0">
      <Link href="/dashboard" className="flex items-center justify-between rounded-md p-2 transition-colors hover:bg-gray-50 dark:hover:bg-gray-800">
